...
If you need, please run the following commands in sequence to obtain a complete synthesized dataset. Alternatively, you can directly download the benchmark from the link above and proceed to [Base model + MIRAGE](#3.2-base-model--mirage) for inference, skipping **Automatic Image Synthesis Pipeline**. 
