...
Alternatively, you can directly download the benchmark from the link above and proceed to [4.2 Base model + MIRAGE](#42-base-model--mirage) for inference, skipping **3. Automatic Image Synthesis Pipeline**. Notably, the entire **MIRAGE-Bench** is constructed based on our proposed **Automatic Image Synthesis Pipeline**.
