...
Alternatively, you can directly download the benchmark from the link above and proceed to [Base model + MIRAGE](#32-base-model--mirage) for inference, or simply follow the Quick Start instructions above without running the **Automatic Image Synthesis Pipeline**.
